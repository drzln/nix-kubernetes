{
  ...
  aws-partitions = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "17ipvfn8m3ffrq1m24kfi0dxyz27lxy26c4f9wxybgphablny2km";
      type = "gem";
    };
    version = "1.1055.0";
  };
  ...
  pangea = {
    dependencies = ["abstract-synthesizer" "aws-sdk-dynamodb" "aws-sdk-s3" "rexml" "terraform-synthesizer" "thor" "toml-rb" "tty-box" "tty-color" "tty-option" "tty-progressbar" "tty-table"];
    groups = ["default"];
    platforms = [];
    source = {
      path = ./.;
