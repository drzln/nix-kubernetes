{
  ...
  aws-sdk-autoscaling = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "099g6mx10zg2qhbmj6gdmdinxsw05ac4kq20x9vn2bbzsrz8ixic";
      type = "gem";
    };
    version = "1.133.0";
  };
  ...
  infra = {
    dependencies = ["abstract-synthesizer" "aws-sdk-autoscaling" "aws-sdk-dynamodb" "aws-sdk-ec2" "aws-sdk-s3" "net" "pangea" "rexml" "terraform-synthesizer" "toml-rb" "tty-box" "tty-color" "tty-option" "tty-progressbar" "tty-table"];
    groups = ["default"];
    platforms = [];
    source = {
      path = ./.;
  ...
  net = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "06d63v81facp56nhdppm2jlpa7ska4z5jjvyhhr8nfv0vh4y8qw7";
      type = "gem";
    };
    version = "0.3.3";
  };
  pangea = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1ynv6m81y9g8mbmsqyc9j8p4w1i5klcrqjpd3izwydgkszcbi7h4";
      type = "gem";
    };
    version = "0.0.54";
  };
